...
if text == (database:get(bot_id.."yousef:Name:Bot") or "لاريكا") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."yousef:Name:Bot") or "لاريكا")
local namebot = {
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- yousef Team .',url="t.me/𝗒𝗈𝗎𝗌𝖾𝖿 𝗅𝖺𝖻𝖻𝖺𝗇 "}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'الملفات' and Devyousef(msg) then
t = '• جميع الملفات : \n  ━═━═━═━\n'
i = 0
for v in io.popen('ls yousef_Files'):lines() do
if v:match(".lua$") then
...
if Devyousef(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Yousef_Labban/files_yousef/master/getfile.json")
if res == 200 then
...
local Check_File_is_Found = io.open("yousef_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and Devyousef(msg) then
local name_t = {string.match(text, "^(تعطيل ملف) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("yousef_Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/Yousef_Labban/files_yousef/master/files_yousef/"..file)
if res == 200 then
os.execute("rm -fr yousef_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('yousef.lua')  
else
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and Devyousef(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Yousef_Labban/files_yousef/master/files_yousef/"..file)
if res == 200 then
local chek = io.open("yousef_Files/"..file,'w+')
...
if text == "مسح جميع الملفات" and Devyousef(msg) then
os.execute("rm -fr yousef_Files/*")
...
local url,res = https.request('https://evzxar.ml/yousef.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.yousef ~= true then
send(msg.chat_id_,msg.id_,'• لا يمكنك استخدام البوت\n• عليك الاشتراك في قناة السورس\n• لتتمكن من استخدام الاوامر \n• CH ~ [@Yousef_Labban]')   
return false 
end
Text = [[
*𝙬𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙨𝙤𝙪𝙧𝙘𝙚* [𝙡𝙖𝙧𝙞𝙘𝙖 𝙩𝙚𝙖𝙢 †](t.me/𝗒𝗈𝗎𝗌𝖾𝖿 𝗅𝖺𝖻𝖻𝖺𝗇)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝙨𝙤𝙪𝙧𝙘𝙚 𝙘𝙝𝙖𝙣𝙣𝙚𝙡',url="https://t.me/𝗒𝗈𝗎𝗌𝖾𝖿 𝗅𝖺𝖻𝖻𝖺𝗇"},
},
{
...
{
{text = '𝙨𝙤𝙪𝙧𝙘𝙚 𝙙𝙚𝙫𝙚𝙡𝙤𝙥𝙚𝙧',url="t.me/Yousef_Labban"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/𝗒𝗈𝗎𝗌𝖾𝖿 𝗅𝖺𝖻𝖻𝖺𝗇&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
• مسح الوسائط
[𝗒𝗈𝗎𝗌𝖾𝖿 𝗅𝖺𝖻𝖻𝖺𝗇](t.me/𝗒𝗈𝗎𝗌𝖾𝖿 𝗅𝖺𝖻𝖻𝖺𝗇)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
inline = {
{{text = '• yousef 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/𝗒𝗈𝗎𝗌𝖾𝖿 𝗅𝖺𝖻𝖻𝖺𝗇'}},
}
...
local Name_Bot = (database:get(bot_id.."yousef:Name:Bot") or "لاريكا")
